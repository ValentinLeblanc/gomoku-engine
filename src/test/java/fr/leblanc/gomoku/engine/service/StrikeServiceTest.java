...
class StrikeServiceTest {
	...
	void findOrCounterStrikeTest() throws InterruptedException {
		...
		assertEquals(new Cell(10, 4), strikeService.findOrCounterStrike(dataWrapper, EngineConstants.BLACK_COLOR));
		
		dataWrapper.addMove(new Cell(10, 4), EngineConstants.BLACK_COLOR);
		
		assertEquals(new Cell(11, 3), strikeService.findOrCounterStrike(dataWrapper, EngineConstants.WHITE_COLOR));
		
		dataWrapper.addMove(new Cell(11, 3), EngineConstants.WHITE_COLOR);
		
		assertEquals(new Cell(10, 6), strikeService.findOrCounterStrike(dataWrapper, EngineConstants.BLACK_COLOR));
		
		dataWrapper.addMove(new Cell(10, 6), EngineConstants.BLACK_COLOR);
		
		assertEquals(new Cell(10, 3), strikeService.findOrCounterStrike(dataWrapper, EngineConstants.WHITE_COLOR));
		
		dataWrapper.addMove(new Cell(10, 3), EngineConstants.WHITE_COLOR);
		
		assertEquals(new Cell(11, 6), strikeService.findOrCounterStrike(dataWrapper, EngineConstants.BLACK_COLOR));
		
		dataWrapper.addMove(new Cell(11, 6), EngineConstants.BLACK_COLOR);
		
		assertEquals(new Cell(12, 6), strikeService.findOrCounterStrike(dataWrapper, EngineConstants.WHITE_COLOR));
